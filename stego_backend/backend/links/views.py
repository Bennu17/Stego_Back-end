...
class FileUploadView(APIView):
  ...
  def post(self, request, *args, **kwargs):
     ...
     try:
         ...
         save_path = 'C:/Users/Administrator/Desktop/testing/{}_original.png'.format(name)
         ...
         for i in range(1,10):
           ...
           if i!=randint:
             ...
             img.save('C:/Users/Administrator/Desktop/testing/{}_original{}.png'.format(name,i))

         x= encode_lsb(save_path, secret_message, 'C:/Users/Administrator/Desktop/testing/{}position.txt'.format(encoded_image_name), encoded_image_name,randint)
...
class DecryptView(APIView):
  ...
  def post(self, request, *args, **kwargs):
    ...
    img_path='C:/Users/Administrator/Desktop/testing/'+os.path.splitext(image.name)[0]+'.png'

    file_path="C:/Users/Administrator/Desktop/testing/"+os.path.splitext(posfile.name)[0]+'.txt'
